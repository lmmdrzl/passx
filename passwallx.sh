...
echo "     ___________ __________________
/__      __// ____// / / /
  /    // __/     / /_/ /
 /    //____/    / __  /
/____/_____/    /_/ /_/  

telegram : @technomodem" >> /etc/banner
...
echo -e "${MAGENTA} Made With Love By : technomodem ${ENDCOLOR}"

sleep 10

uci set system.@system[0].hostname=By-technomodem
